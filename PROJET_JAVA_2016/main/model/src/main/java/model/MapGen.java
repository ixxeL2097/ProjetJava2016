...
public class MapGen implements IMapGen				// main class of elements's instanciation. MapGen is used to create all elements, moving or not
{
	...
	/**
	 * @param MapNumber
	 * 		L'ID de la map que l'on charge
	 * @param model
	 * 			Recupere le model de la map
	 */
	 ...
	 * 
	 * @param elem
	 * 			L'element mobile à placer
	 * @param y
	 * 			La coordonnée y de l'element à placer
	 * @param x
	 * 			La coordonnée x de l'element à placer
	 */
